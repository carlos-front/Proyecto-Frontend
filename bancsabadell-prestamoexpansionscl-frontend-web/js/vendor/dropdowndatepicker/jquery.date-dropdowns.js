 ...
 *  Under MIT License
 *
 *  Multilanguage v1.1.0 by BeRepublic
 */
;(function ($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
        ...
        init: function () {
            ...
            this.setInternalVariables(this.config.language);
            this.setupMarkup();
            this.buildDropdowns();
         ...
         */
        setInternalVariables: function (lang) {
            var date = new Date();
            ...
            if (lang=='en') {
                ...
                this.internals.monthShort = ['Ene', 'Feb', 'Mar', 'Abr', 'May', 'Jun', 'Jul', 'Ago', 'Sep', 'Oct', 'Nov', 'Dic'];
                this.internals.monthLong = ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre'];
            }
            else if (lang=='ca') {
                this.internals.monthShort = ['Gen', 'Feb', 'Mar', 'Abr', 'Mai', 'Jun', 'Jul', 'Ago', 'Set', 'Oct', 'Nov', 'Des'];
                this.internals.monthLong = ['Gener', 'Febrer', 'Març', 'Abril', 'Maig', 'Juny', 'Juliol', 'Agost', 'Setembre', 'Octubre', 'Novembre', 'Desembre'];
            }
        },
