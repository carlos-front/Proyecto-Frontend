...
$subject = 'Comprar seguro en Internet'; // PENDING
...
<p> <strong>Apellidos:</strong> ' . htmlspecialchars($_POST["apellidos"]) . '</p>
<p> <strong>NIF-NIE:</strong> ' . htmlspecialchars($_POST["dni"]) . '</p>
<p> <strong>Email:</strong> ' . htmlspecialchars($_POST["email"]) . '</p>
<p> <strong>Dirección tienda favorita:</strong> ' . htmlspecialchars($_POST["url"]) . '</p>
</body></html>';
    ...
    $text = "Registro recibido \nNombre: " . $_POST["nombre"]
        ...
        . "\nNIF-NIE: " . $_POST["dni"]
        . "\nEmail: " . $_POST["email"]
        . "\nDirección tienda favorita: " . $_POST["url"];
