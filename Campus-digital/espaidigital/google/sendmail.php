...
$subject = 'Digitalitza\'t amb Google'; // PENDING
...
<h2> Registre rebut </h2>
<p> <strong>Nom i cognoms:</strong> ' . htmlspecialchars($_POST["nombre"]) . '</p>
<p> <strong>Email:</strong> ' . htmlspecialchars($_POST["email"]) . '</p>
<p> <strong>NIF-NIE:</strong> ' . htmlspecialchars($_POST["dni"]) . '</p>
<p> <strong>Eines:</strong> ';
    foreach ($_POST['tool'] as $tool) {
        $html .= "<br />" . $tool;
    }
    $html .= '</p>
    <p> <strong>Comentari:</strong> ' . htmlspecialchars($_POST["comentario"]) . '</p>
</body></html>';

    $text = "Registre rebut \nNom i cognoms: " . $_POST["nombre"]
        . "\nEmail: " . $_POST["email"]
        . "\nNIF-NIE: " . $_POST["dni"]
        . "\nEines: ";
    foreach ($_POST['tool'] as $tool) {
